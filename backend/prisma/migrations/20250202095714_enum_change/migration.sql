...
CREATE TABLE "new_Duel" (
    ...
    CONSTRAINT "Duel_activeUserId_fkey" FOREIGN KEY ("activeUserId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Duel" ("activeUserId", "createdAt", "id", "image1Id", "image2Id", "isFinished", "outcome", "voterId") SELECT "activeUserId", "createdAt", "id", "image1Id", "image2Id", "isFinished", "outcome", "voterId" FROM "Duel";
DROP TABLE "Duel";
